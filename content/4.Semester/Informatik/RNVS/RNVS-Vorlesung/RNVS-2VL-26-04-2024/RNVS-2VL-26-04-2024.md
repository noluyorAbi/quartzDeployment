...
date modified: Friday, 26. April 2024, 11:02
---
...
```mermaid
graph TD;
    A[Nachricht, Ziel] -->|Transport der Nachricht| B[Daten, Verb.Info]
    B -->|Weg durch das Netz| C[Daten, Weginfo]
    C -->|Datenübertragung| D[Bits, Kanal]
...
- vertikale
	- mit einer benachberten Schicht
- horizontale
