...
- **aus welchem Schema:** Durch `Schema(Angestellter)` wird spezifiziert, dass `t` Tupel aus dem Schema der Angestellten repräsentiert.
...
### b) Erstellen Sie eine Liste aller Verkaufsnummern mit Verkaufsdatum, die in den Abteilungen im 3. Stock verkauft wurden und deren Lieferant entweder aus Italien oder aus Frankreich kommt. [[Uni2/Semester/3. Semester/DBS/ÜB/ÜB 6/Blatt 6]]
