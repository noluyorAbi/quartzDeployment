...
## Erläutern Sie die Vorteile, die Datenbanksysteme gegenüber Dateiverwaltungssystemen durch die [[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/3 - Ebenenarchitektur]] (Externe, Interne, Konzeptionelle Ebene) besitzen. Insbesondere soll dabei auf folgende Punkte eingegangen werden: [[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Unterschiede zwischen Datenbanksystemen und Dateiverwaltungssystemen]]
...
## a) Welcher Nachteil ergibt sich, wenn die Tabelle nach obigem Schema gespeichert wird? [[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen]]

- Mitarbeiterzahl existiert mehrmals in der Tabelle als nötig ([[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen#Redundanz|Redundanz]])
- Es kann kein Studio existieren ohne Spiel, was nicht der Realität entspricht. Es müssen immer ganze Zeilen eingefügt werden ([[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen#Einfügeanomalie|Einfügeanomalie]])
- Bei einer Änderung der Mitarbeiteranzahl müssen mehrere Zeilen geändert werden was unnötigen Overhead darstellt. ([[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen#Änderungsanomalie|Änderungsanomalie]])
- Beim Löschen gehen Informationen verloren die nicht verloren gehen sollten. Bsp. beim löschen von E.T geht auch die Information der Mitarbeiteranzahl von Atari verloren. ([[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen#Entfernungsanomalie|Entfernungsanomalie]])
...
- Da die Mitarbeiteranzahl bei jedem Spiel gespeichert wird muss sie in jeder Zeile wo LucasArts als Studio vertreten ist geändert werden. Das ist unnötige Arbeit welche zu Fehlern und einer inkonsistenten Datenbank führen kann, falls diese Info nicht in jeder Zeile umgeändert wird. Dies nennt man auch [[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen#Änderungsanomalie|Änderungsanomalie.]]
...
- Es kann kein Studio hinzugefügt werden, was noch kein Spiel veröffentlicht hat, da sonst notwendige Inforamtionen wie Spiel und Erscheinungsdatum in der Zeile fehlen → [[Uni2/Semester/3. Semester/DBS/Erklärungen/Grundlagen der Datenbanktheorie/Anomalien in Datenbanksystemen#Einfügeanomalie|Einfügeanomalie]]
...
Als nächstes: [[Uni2/Semester/3. Semester/DBS/ÜB/ÜB 3/Blatt 3]]