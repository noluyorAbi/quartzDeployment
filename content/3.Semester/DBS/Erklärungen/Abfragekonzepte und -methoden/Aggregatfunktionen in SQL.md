...
- <b style="color:red;">Achtung!</b> Average benötigt bei mehr als einer Attribute im `SELECT` [[Uni2/Semester/3.Semester/DBS/Erklärungen/Abfragekonzepte und -methoden/Aggregatfunktionen in SQL#GROUP BY|GROUP BY]]  
...
# [[Uni2/Semester/3.Semester/DBS/Erklärungen/Abfragekonzepte und -methoden/Erweiterte Abfragen in SQL#Reihenfolge|Reihenfolge der Keywords]]